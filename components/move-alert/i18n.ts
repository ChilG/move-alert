...
const th = {
  ...
  settings: {
    ...
    scheduledNotificationsTitle: 'รายการแจ้งเตือนที่ตั้งเวลาไว้',
    scheduledNotificationsDescription:
      'ดู reminder notification ที่ถูก schedule อยู่บนอุปกรณ์นี้ เพื่อเช็กว่ามีรายการของวันถัดไปจริงหรือไม่',
    scheduledNotificationsRefresh: 'รีเฟรชรายการ',
    scheduledNotificationsEmpty: 'ยังไม่มี reminder notification ที่ถูก schedule ไว้',
    scheduledNotificationsUnsupported: 'รายการนี้รองรับเฉพาะบน Android เท่านั้น',
    scheduledNotificationsLoadFailed: 'โหลดรายการแจ้งเตือนไม่สำเร็จ',
    scheduledNotificationsUnknownTime: 'ไม่พบเวลาที่ตั้งไว้',
    scheduledNotificationsIdentifier: 'ID',
...
const en: Locale = {
  ...
  settings: {
    ...
    scheduledNotificationsDescription:
      'Review reminder notifications currently scheduled on this device to verify that tomorrow is queued.',
    scheduledNotificationsRefresh: 'Refresh list',
    scheduledNotificationsEmpty: 'No reminder notifications are currently scheduled.',
    scheduledNotificationsUnsupported: 'This list is only supported on Android.',
    scheduledNotificationsLoadFailed: 'Unable to load scheduled notifications.',
    scheduledNotificationsUnknownTime: 'Scheduled time unavailable',
    scheduledNotificationsIdentifier: 'ID',
