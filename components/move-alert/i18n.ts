...
const th = {
  ...
  onboarding: {
    ...
    requiredFeatureTitle: 'เปิดสิทธิ์ที่จำเป็น',
    requiredFeatureDescription: 'เปิดการแจ้งเตือน และอนุญาตการทำงานเบื้องหลังเพื่อให้ Move Alert เตือนคุณได้จริง',
    requiredFeatureNotificationTitle: 'Notification permission',
    requiredFeatureNotificationDescription: 'จำเป็นสำหรับการส่งการเตือนให้ลุกขยับตามรอบที่คุณตั้งไว้',
    requiredFeatureBatteryTitle: 'Battery Optimization',
    requiredFeatureBatteryDescription: 'แนะนำสำหรับ Android เพื่อให้การเตือนยังทำงานได้เมื่อแอปอยู่เบื้องหลัง',
    requiredFeatureAction: 'เปิดการแจ้งเตือน',
    requiredFeatureConfigured: 'เปิดแล้ว',
  ...
  today: {
    ...
    requiredFeatureTitle: 'ต้องเปิดการตั้งค่าที่จำเป็น',
    requiredFeatureSummaryAll: 'เปิด Notification และตั้งค่า Battery เพื่อให้การเตือนทำงานได้ครบถ้วน',
    requiredFeatureSummaryNotification: 'เปิด Notification เพื่อให้ Move Alert ส่งการเตือนให้ขยับได้',
    requiredFeatureSummaryBattery: 'ตั้งค่า Battery เพื่อให้การเตือนทำงานได้ดีขึ้นเมื่อแอปอยู่เบื้องหลัง',
    requiredFeatureAction: 'ตั้งค่าฟีเจอร์ที่จำเป็น',
  },
  requiredFeature: {
    eyebrow: 'Required feature',
    title: 'เปิดสิ่งที่จำเป็นสำหรับการเตือน',
    description: 'Move Alert ต้องใช้ Notification เป็นหลัก และบน Android ควรอนุญาตการทำงานเบื้องหลังด้วย',
    notificationStatusLabel: 'สถานะ Notification',
    notificationAllowed: 'เปิดแล้ว',
    notificationBlocked: 'ยังไม่ได้เปิด',
    notificationDescription: 'หากไม่เปิด Notification แอปจะไม่สามารถส่งการเตือนให้ลุกขยับตามรอบที่ตั้งไว้ได้',
    notificationAction: 'เปิด Notification',
    notificationConfiguredAction: 'เปิด Notification แล้ว',
    batteryStatusLabel: 'สถานะ Battery',
    batteryDescription: 'ระบบประหยัดแบตของ Android อาจหน่วงหรือหยุดการเตือนเมื่อแอปไม่ได้เปิดอยู่',
  },
  batteryOptimization: {
...
const en: Locale = {
  ...
  onboarding: {
    ...
    requiredFeatureTitle: 'Enable required access',
    requiredFeatureDescription:
      'Turn on notifications and allow background activity so Move Alert can actually remind you.',
    requiredFeatureNotificationTitle: 'Notification permission',
    requiredFeatureNotificationDescription: 'Required for movement reminders at the interval you choose.',
    requiredFeatureBatteryTitle: 'Battery Optimization',
    requiredFeatureBatteryDescription:
      'Recommended on Android so reminders can keep working while the app is in the background.',
    requiredFeatureAction: 'Enable notifications',
    requiredFeatureConfigured: 'Enabled',
  ...
  today: {
    ...
    requiredFeatureTitle: 'Required setup is missing',
    requiredFeatureSummaryAll: 'Turn on notifications and battery access so reminders can work fully.',
    requiredFeatureSummaryNotification: 'Turn on notifications so Move Alert can send movement reminders.',
    requiredFeatureSummaryBattery: 'Set up battery access so reminders work better in the background.',
    requiredFeatureAction: 'Set up required features',
  },
  requiredFeature: {
    eyebrow: 'Required feature',
    title: 'Enable what reminders need',
    description: 'Move Alert depends on notifications, and Android should also allow background activity.',
    notificationStatusLabel: 'Notification status',
    notificationAllowed: 'Allowed',
    notificationBlocked: 'Not allowed',
    notificationDescription:
      'Without notifications, the app cannot send movement reminders at the interval you choose.',
    notificationAction: 'Turn on notifications',
    notificationConfiguredAction: 'Notifications are on',
    batteryStatusLabel: 'Battery status',
    batteryDescription: 'Android battery saving may delay or stop reminders while the app is in the background.',
  },
  batteryOptimization: {
    eyebrow: 'Battery Optimization',
