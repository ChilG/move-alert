...
export function SettingsNotificationDebugSection({
  ...
  return (
    <SectionCard className="mt-6">
      ...
      <Button className="mt-4 rounded-xl" disabled={isLoading} onPress={onSendDebugNotification} size="lg">
        <Ionicons color={getButtonForegroundColor(colors, 'primary', 'solid')} name="notifications-outline" size={18} />
